...
public class DispositivoInteligente {
	...
	public double getConsumo(Periodo unPeriodo) {
		...
		return historialConsumo
				.stream()
				.filter(consumo -> unPeriodo.contiene(consumo.getPeriodo()))
				.mapToDouble(consumo -> consumo.getConsumo(consumoPorHora))
				.sum();
	}
	...
	public void setModoDeOperacion(EstadoDispositivo nuevoModo) { // el nombre puede cambiar
