...
public class RestriccionHorasUsoMayor extends Restriccion {

	private DispositivoInteligente dispositivo;
	private double valor;
	
	public RestriccionHorasUsoMayor(DispositivoInteligente dispositivo, double valor) {
	...
	public LinearConstraint toLinearConstraint(Collection<DispositivoInteligente> dispositivos) {
		...
		return new LinearConstraint(getCoeficientes(dispositivo, dispositivos), Relationship.GEQ, valor);
	}
}